...
$files = $collector->invoke( new VRodos_Scene_Standalone_Exporter(), '<script src="http://wp.local/wp-content/plugins/VRodos/assets/js/runtime/master/lib/vrodos-runtime-spatial-ui.bundle.js"></script>' );
foreach ( [
