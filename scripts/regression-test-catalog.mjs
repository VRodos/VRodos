...
export const testGroups = Object.freeze({
  "runtime": [
    "scripts/test-native-headset-presentation.mjs",
    "scripts/test-selection-bvh.mjs",
    ...
    "scripts/test-asset-geometry-policy.mjs",
    "scripts/test-animated-glb-derivative.mjs",
    ...
    "scripts/test-compiled-glb-animation.mjs",
    "scripts/test-editor-scene-loader.mjs",
    "scripts/test-editor-oversized-glb.mjs",
    "scripts/test-scene-asset-role.mjs",
    "scripts/test-asset-editor-save-progress.mjs",
    "scripts/test-asset-upload-cancel.mjs",
    "scripts/test-asset-upload-cancel-server.php",
  ...
  "compiler": [
    ...
    "scripts/test-background-jobs.php",
    ...
    "scripts/test-audio-asset-model-default.php",
    "scripts/test-scene-settings-save.php",
    "scripts/test-scene-text-save.php",
    ...
    "scripts/test-surface-texture-optimizer.php",
