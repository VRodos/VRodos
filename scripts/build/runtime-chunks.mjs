...
export const runtimeBuildChunks = Object.freeze([
  ...
  },
  {
    ...
    sourceFiles: [
      ...
      masterSource('vrodos_celestial_lighting.js'),
      masterSource('vrodos_render_quality.js'),
      ...
      masterSource('vrodos_atmosphere_visuals.js'),
  ...
  },
  {
    ...
    sourceFiles: [
      ...
      'components/vrodos_glb_animation.component.js',
