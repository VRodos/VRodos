...
//			fclose($f);
        ...
        function createBasicDomStructureAframeActor($content, $scene_json)
        {
            ...
            @$dom->loadHTML($content, LIBXML_HTML_NOIMPLIED | LIBXML_NOBLANKS | LIBXML_NOERROR); //LIBXML_NOERROR , LIBXML_HTML_NODEFDTD
        ...
        function createBasicDomStructureAframeDirector($content, $scene_json, $project_id, $scene_id, $scene_id_list)
        {
            ...
            @$dom->loadHTML($content, LIBXML_HTML_NOIMPLIED | LIBXML_NOBLANKS | LIBXML_NOERROR); // LIBXML_HTML_NODEFDTD, LIBXML_NOERROR
