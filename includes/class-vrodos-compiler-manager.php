...
class VRodos_Compiler_Manager {
    ...
    private function createIndexFile( $project_title, $scene_id, $scene_title ) {
        ...
        return $this->writer( $this->plugin_path_dir . "/build/" . "index_" . $scene_id . ".html", $content );
    }
    ...
    private function createMasterClient($project_title, $scene_id, $scene_title, $scene_json, $showPawnPositions, $index, $project_id, $scene_id_list){
        ...
        // Read prototype
        $content = $this->reader($this->plugin_path_dir
        ...
        $ascene->setAttribute("networked-scene", "app: $app_name; room: room$scene_id; debug: true; audio: $enable_director_audio; adapter: easyrtc; serverURL: /; connectOnLoad: true; onConnect: connectionResolve;");
        ...
        // Write back to root
        return $this->writer($this->plugin_path_dir.'/build/Master_Client_'.$scene_id.".html", $contentNew);
    }
    ...
    private function createSimpleClient($project_title, $scene_id, $scene_title, $scene_json, $project_id){
        ...
        $this->writer("output_simple_client.html", print_r($basicDomElements, true));
        ...
        // Write back to root
        return $this->writer($this->plugin_path_dir.'/build/Simple_Client_'.$scene_id.".html", $contentNew);
    }
