...
function vrodos_default_value_terrain_get(){
    global $ini_asset_terrain;
    return $ini_asset_terrain[0];
}

function vrodos_default_value_consumer_get(){
    global $ini_asset_consumer;
    return $ini_asset_consumer[0];
}

function vrodos_default_value_producer_get(){
    global $ini_asset_producer;
    return $ini_asset_producer[0];
}

function vrodos_default_value_decoration_energy_get(){
    global $ini_asset_staticDec;
    return $ini_asset_staticDec[0];
}

function vrodos_default_value_marker_get(){
...
function vrodos_default_value_AudioManager_energy_get(){
    global $AudioManager_asset;
    return $AudioManager_asset[0];
}

function vrodos_default_value_ClusterInputManager_energy_get(){
    global $ClusterInputManager_asset;
    return $ClusterInputManager_asset[0];
}

function vrodos_default_value_DynamicsManager_energy_get(){
    global $DynamicsManager_asset;
    return $DynamicsManager_asset[0];
}

function vrodos_default_value_EditorBuildSettings_energy_get(){
    global $EditorBuildSettings_asset;
    return $EditorBuildSettings_asset[0];
}

function vrodos_default_value_EditorSettings_energy_get(){
    global $EditorSettings_asset;
    return $EditorSettings_asset[0];
}

function vrodos_default_value_GraphicsSettings_energy_get(){
    global $GraphicsSettings_asset;
    return $GraphicsSettings_asset[0];
}

function vrodos_default_value_InputManager_energy_get(){
    global $InputManager_asset;
    return $InputManager_asset[0];
}

function vrodos_default_value_NavMeshAreas_energy_get(){
    global $NavMeshAreas_asset;
    return $NavMeshAreas_asset[0];
}

function vrodos_default_value_NetworkManager_energy_get(){
    global $NetworkManager_asset;
    return $NetworkManager_asset[0];
}

function vrodos_default_value_Physics2DSettings_energy_get(){
    global $Physics2DSettings_asset;
    return $Physics2DSettings_asset[0];
}

function vrodos_default_value_ProjectSettings_energy_get(){
    global $ProjectSettings_asset;
    return $ProjectSettings_asset[0];
}

function vrodos_default_value_ProjectVersion_energy_get(){
    global $ProjectVersion_asset;
    return $ProjectVersion_asset[0];
}

function vrodos_default_value_QualitySettings_energy_get(){
    global $QualitySettings_asset;
    return $QualitySettings_asset[0];
}

function vrodos_default_value_TagManager_energy_get(){
    global $TagManager_asset;
    return $TagManager_asset[0];
}

function vrodos_default_value_TimeManager_energy_get(){
    global $TimeManager_asset;
    return $TimeManager_asset[0];
}

function vrodos_default_value_unityConnect_energy_get(){
...
function vrodos_getAssetYAML_energy($myasset_type){
  $def_json = '';
...
function vrodos_getSceneYAML_energy($myscene_type){
  $def_json = '';
