...
class VRodos_Post_Type_Manager {
    ...
    public function vrodos_project_cpt_construct(): void {
        ...
        $labels = ['name'               => _x( 'Projects', 'post type general name'), 'singular_name'      => _x( 'Project', 'post type singular name'), 'menu_name'          => _x( 'Projects', 'admin menu'), 'name_admin_bar'     => _x( 'Project', 'add new on admin bar'), 'add_new'            => _x( 'Add New', 'add new on menu'), 'add_new_item'       => __( 'Add New Project'), 'new_item'           => __( 'New Project'), 'edit'               => __( 'Edit'), 'edit_item'          => __( 'Edit Project'), 'view'               => __( 'View'), 'view_item'          => __( 'View Project'), 'all_items'          => __( 'All Projects'), 'search_items'       => __( 'Search Projects'), 'parent_item_colon'  => __( 'Parent Projects:'), 'parent'             => __( 'Parent Project'), 'not_found'          => __( 'No Projects found.'), 'not_found_in_trash' => __( 'No Projects found in Trash.')];
    ...
    public function vrodos_project_taxtype_create(): void {
        ...
        $labels = ['name'              => _x( 'Project Type', 'taxonomy general name'), 'singular_name'     => _x( 'Project Type', 'taxonomy singular name'), 'menu_name'         => _x( 'Project Types', 'admin menu'), 'search_items'      => __( 'Search Project Types'), 'all_items'         => __( 'All Project Types'), 'parent_item'       => __( 'Parent Project Type'), 'parent_item_colon' => __( 'Parent Project Type:'), 'edit_item'         => __( 'Edit Project Type'), 'update_item'       => __( 'Update Project Type'), 'add_new_item'      => __( 'Add New Project Type'), 'new_item_name'     => __( 'New Project Type')];

        $args = ['description' => 'Type of Game Project', 'labels'    => $labels, 'public'    => false, 'show_ui'   => true, 'hierarchical' => true, 'show_admin_column' => true, 'capabilities' => ['manage_terms' => 'manage_vrodos_project_type', 'edit_terms' => 'manage_vrodos_project_type', 'delete_terms' => 'manage_vrodos_project_type', 'assign_terms' => 'edit_vrodos_project_type']];

        register_taxonomy('vrodos_game_type', 'vrodos_game', $args);
    }

    public function vrodos_projects_taxtypes_define(): void {
        wp_insert_term('archaeology','vrodos_game_type',       ['description'=> 'Default Projects', 'slug' => 'archaeology_games']);
        wp_insert_term('vrexpo',     'vrodos_game_type',       ['description'=> 'Exhibition Projects', 'slug' => 'vrexpo_games']);
        wp_insert_term('virtualproduction','vrodos_game_type', ['description'=> 'Virtual Production Projects', 'slug' => 'virtualproduction_games']);
    }
    ...
    public function vrodos_scenes_parent_project_tax_define(): void {
        $labels = ['name' => _x('Scene Parent Taxonomy', 'taxonomy general name'), 'singular_name' => _x('Parent Taxonomy', 'taxonomy singular name'), 'menu_name' => _x('Parent Taxonomies', 'admin menu'), 'search_items' => __('Search Parent Taxonomies'), 'all_items' => __('All Scene Parent Taxonomies'), 'parent_item' => __('Scene Parent Taxonomy'), 'parent_item_colon' => __('Scene Parent Taxonomy:'), 'edit_item' => __('Edit Parent Taxonomy'), 'update_item' => __('Update Parent Taxonomy'), 'add_new_item' => __('Add New Parent Taxonomy'), 'new_item_name' => __('New Parent Taxonomy')];

        $args = ['description' => 'Parent Taxonomy that the Scene belongs to', 'labels' => $labels, 'public' => true, 'show_ui' => true, 'show_in_menu' => true, 'hierarchical' => false, 'show_admin_column' => true, 'capabilities' => ['manage_terms' => 'manage_vrodos_taxpgame', 'edit_terms' => 'manage_vrodos_taxpgame', 'delete_terms' => 'manage_vrodos_taxpgame', 'assign_terms' => 'edit_vrodos_taxpgame']];
    ...
    public function vrodos_assets_taxcategory(): void {
        ...
        $labels = ['name' => _x('Asset Type', 'taxonomy general name'), 'singular_name' => _x('Asset Type', 'taxonomy singular name'), 'menu_name' => _x('Asset Types', 'admin menu'), 'search_items' => __('Search Asset Types'), 'all_items' => __('All Asset Types'), 'parent_item' => __('Parent Asset Type'), 'parent_item_colon' => __('Parent Asset Type:'), 'edit_item' => __('Edit Asset Type'), 'update_item' => __('Update Asset Type'), 'add_new_item' => __('Add New Asset Type'), 'new_item_name' => __('New Asset Type')];

        $args = ['description' => 'Type of 3D asset', 'labels' => $labels, 'public' => false, 'show_ui' => true, 'hierarchical' => false, 'show_admin_column' => true, 'capabilities' => ['manage_terms' => 'manage_vrodos_asset3d_cat', 'edit_terms' => 'manage_vrodos_asset3d_cat', 'delete_terms' => 'manage_vrodos_asset3d_cat', 'assign_terms' => 'edit_vrodos_asset3d_cat']];
    ...
    public function vrodos_assets_taxpgame(): void {
        ...
        $labels = ['name' => _x('Asset Parent Taxonomy', 'taxonomy general name'), 'singular_name' => _x('Parent Taxonomy', 'taxonomy singular name'), 'menu_name' => _x('Parent Taxonomies', 'admin menu'), 'search_items' => __('Search Parent Taxonomies'), 'all_items' => __('All Asset Parent Taxonomies'), 'parent_item' => __('Asset Parent Taxonomy'), 'parent_item_colon' => __('Asset Parent Taxonomy:'), 'edit_item' => __('Edit Parent Taxonomy'), 'update_item' => __('Update Parent Taxonomy'), 'add_new_item' => __('Add New Parent Taxonomy'), 'new_item_name' => __('New Parent Taxonomy')];

        $args = ['description' => 'Parent Taxonomy assignment of a 3D Asset', 'labels' => $labels, 'public' => false, 'show_ui' => true, 'hierarchical' => false, 'show_admin_column' => true, 'capabilities' => ['manage_terms' => 'manage_vrodos_asset3d_pgame', 'edit_terms' => 'manage_vrodos_asset3d_pgame', 'delete_terms' => 'manage_vrodos_asset3d_pgame', 'assign_terms' => 'edit_vrodos_asset3d_pgame']];
    ...
    public function vrodos_assets_taxcategory_ipr(): void {
        $labels = ['name' => _x('Asset IPR', 'taxonomy general name'), 'singular_name' => _x('Asset IPR', 'taxonomy singular name'), 'menu_name' => _x('Asset IPR', 'admin menu'), 'search_items' => __('Search Asset by IPR'), 'all_items' => __('All Asset IPRs'), 'parent_item' => __('Parent Asset IPR'), 'parent_item_colon' => __('Parent Asset IPR:'), 'edit_item' => __('Edit Asset IPR'), 'update_item' => __('Update Asset IPR'), 'add_new_item' => __('Add New Asset IPR'), 'new_item_name' => __('New Asset IPR')];
        ...
        foreach ($terms_ipr as $ti) {
            wp_insert_term($ti[0], 'vrodos_asset3d_ipr_cat', ['description' => $ti[1], 'slug' => $ti[2]]);
        }
    }
}
