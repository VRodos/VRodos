...
<div id="popUpArtifactPropertiesDiv" class="EditorObjOverlapSelectStyle mdc-theme--background mdc-elevation--z2"
    style="min-width: 200px;display:none; max-width:450px;padding:0px;">
    ...
    <div id="popup_artifact_scroller" style="overflow-y: scroll; height:300px;padding: 15px;margin: 0px;">
        ...
        <label for="artifact_override_material_checkbox" class="mdc-textfield__label"
            style="top: 8px; position: initial; width: 150px; display: inline-block;margin-top: 15px;">Override glb
            material?</label>
        <input type="checkbox" title="Select if you want to set custom colors" id="artifact_override_material_checkbox"
            name="artifact_override_material_checkbox" class="mdc-textfield__input mdc-theme--text-primary-on-light"
            style="width: 1ch;padding: 2px;display: inline-block; text-align: right;"
            oninput="changeOverrideMaterial(this);">
        <br />

        <!-- The Color of the object -->
        <label for="ObjectColor" class="mdc-textfield__label"
        ...
        <label for="ObjectEmissiveColor" class="mdc-textfield__label"
            style="top: 12px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
            Object Emissive:</label>

        <input type="text" id="ObjectEmissiveColor" name="ObjectEmissiveColor"
            title="Set a hex number, ffffff is the default (white)" value="ffffff" maxlength="6"
            class="jscolor {onFineChange:'updateObjectEmissiveColorPicker(this)'}"
            style="width: 70px;display: inline-block;padding: 2px;text-align: right;" />
        <br />

        <!-- Emissive Intensity -->
        <label for="ObjectEmissiveIntensity" class="mdc-textfield__label"
            style="top: 12px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
        ...
        <div class="mdc-slider" style="width:50%; display:inline-block; height:30px">
            <input class="mdc-slider__input" type="range" min="0" max="1" value="0.5" step="0.01"
                id="ObjectEmissiveIntensity" name="ObjectEmissiveIntensity" aria-label="Emissive intensity slider"
                oninput="changeEmissiveIntensity(this);">
        ...
        <!-- Roughness -->
        <label for="ObjectRoughness" class="mdc-textfield__label"
            style="top: 12px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
            Roughness:</label>
        <div class="mdc-slider" style="width:50%; display:inline-block; height:30px">
            <input class="mdc-slider__input" type="range" min="0" max="1" value="0.5" step="0.01" id="ObjectRoughness"
                name="ObjectRoughness" aria-label="Roughness slider" oninput="changeRoughness(this);">
            <div class="mdc-slider__thumb">
                <div class="mdc-slider__thumb-knob"></div>
            </div>
        </div>
        ...
        <!-- Metalness -->
        <label for="ObjectMetalness" class="mdc-textfield__label"
            style="top: 12px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
            Metalness:</label>
        <div class="mdc-slider" style="width:50%; display:inline-block; height:30px">
            <input class="mdc-slider__input" type="range" min="0" max="1" value="0.5" step="0.01" id="ObjectMetalness"
                name="ObjectMetalness" aria-label="Metalness slider" oninput="changeMetalness(this);">
            <div class="mdc-slider__thumb">
                <div class="mdc-slider__thumb-knob"></div>
            </div>
        </div>
        ...
        <label for="ObjectVideoTexture" class="mdc-textfield__label"
            style="top: 16px; position: relative; bottom: 5px; margin-bottom: 15px; display: inline-block; vertical-align: center;">
            Texture:</label>
        ...
        <label for="ObjectVideoTextureRotation" class="mdc-textfield__label"
            style="top: 16px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
        ...
        <label for="ObjectVideoTextureCenterX" class="mdc-textfield__label"
            style="top: 16px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
        ...
        <label for="ObjectVideoTextureCenterY" class="mdc-textfield__label"
            style="top: 16px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
        ...
        <label for="ObjectVideoTextureRepeatX" class="mdc-textfield__label"
            style="top: 16px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
        ...
        <label for="ObjectVideoTextureRepeatY" class="mdc-textfield__label"
            style="top: 16px; position: relative; bottom: 5px; margin-bottom: 15px; width: 150px; display: inline-block; vertical-align: bottom;">
        ...
        <label for="artifact_reward_checkbox" class="mdc-textfield__label"
            style="top: 8px; position: initial; width: 150px; display: inline-block;margin-top: 15px;">Is a reward
            item?</label>
        <input type="checkbox" title="Select if it is a reward item" id="artifact_reward_checkbox"
            name="artifact_reward_checkbox" class="mdc-textfield__input mdc-theme--text-primary-on-light"
            style="width: 1ch;padding: 2px;display: inline-block; text-align: right;">
        <br />
    </div>
</div>
