...
<div id="right-elements-panel" class="right-elements-panel-style tw-flex tw-flex-col tw-text-white/90">
    ...
    <!-- Extra options -->
    <div class="tw-w-full tw-m-0 tw-overflow-y-auto tw-bg-transparent tw-px-3 tw-py-3 tw-flex-1 tw-min-h-0">
        ...
        <div class="tw-flex tw-items-center tw-gap-2 tw-mt-6 tw-mb-2">
