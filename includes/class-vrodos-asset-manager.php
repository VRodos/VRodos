...
class VRodos_Asset_Manager {
	...
	public function register_scripts() {
      ...
      ['vrodos_compile_dialog_ui', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_compile_dialog_ui.js' ), ['vrodos_namespace', 'vrodos_ui_helpers', 'vrodos_compile_dialogue', 'vrodos_CompileUI_Profiles', 'ajax-script_compile', 'ajax-script_savescene']],
      ...
      ['vrodos_CompileUI_Profiles', VRodos_Path_Manager::editor_js_url( 'ui/compile/vrodos_compile_ui_profiles.js' ), ['vrodos_namespace', 'vrodos_compile_dialogue', 'vrodos_runtime_settings_contract']],
