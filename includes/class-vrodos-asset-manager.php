...
class VRodos_Asset_Manager {
	...
	public function enqueue_asset_admin_scripts( $hook ): void {
		...
		if ( 'vrodos_asset3d' === $screen->post_type ) {
			...
			wp_enqueue_script( 'vrodos_loader_decoder_config' );
		}
	}
	...
	public function register_scripts() {
		...
		$compile_postfx_version    = (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ui/compile/vrodos_compile_ui_postfx.js' ) );
		...
		$scene_persistence_version = (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/scene/vrodos_scene_persistence.js' ) );
		$save_scene_version        = (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ajax/vrodos_save_scene_ajax.js' ) );
		$ui_helpers_version        = (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ui/vrodos_ui_helpers.js' ) );
		$asset_browser_version     = (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ui/vrodos_asset_browser_toolbar.js' ) );

		$scripts = [
      // Foundation
      ['vrodos_namespace', VRodos_Path_Manager::editor_js_url( 'vrodos_namespace.js' )],
      ['vrodos_surface_material', VRodos_Path_Manager::runtime_master_url( 'vrodos_surface_material.js' ), ['vrodos_three_vendor_bundle']],
      ['vrodos_scene_light_artifacts', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_light_artifacts.js' ), ['vrodos_namespace', 'vrodos_three_vendor_bundle'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/scene/vrodos_scene_light_artifacts.js' ) )],
      ...
      ['vrodos_UndoEngine', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_undo_engine.js' ), ['vrodos_namespace', 'vrodos_ScenePersistence', 'vrodos_scene_light_artifacts', 'vrodos_scene_disposal'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/scene/vrodos_undo_engine.js' ) )],
      ...
      ['vrodos_ScenePersistence', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_persistence.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_scene_settings_schema'], $scene_persistence_version],
      ...
      ['ajax-script_filebrowse', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_asset_browser_toolbar.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_ui_helpers', 'vrodos_cefr_badges'], $asset_browser_version],
      ['ajax-script_savescene', VRodos_Path_Manager::editor_ajax_js_url( 'vrodos_save_scene_ajax.js' ), ['vrodos_namespace', 'vrodos_ScenePersistence'], $save_scene_version],
      ['ajax-script_uploadimage', VRodos_Path_Manager::editor_ajax_js_url( 'uploadimage.js' ), ['vrodos_namespace', 'ajax-script_savescene']],
      ['ajax-script_surface_texture', VRodos_Path_Manager::editor_ajax_js_url( 'vrodos_surface_texture.js' ), ['vrodos_namespace', 'ajax-script_savescene'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ajax/vrodos_surface_texture.js' ) )],
      ...
      ['vrodos_editor_director_helpers', VRodos_Path_Manager::editor_js_url( 'render/vrodos_editor_director_helpers.js' ), ['vrodos_namespace', 'vrodos_editor_environment_helpers', 'vrodos_three_vendor_bundle'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/render/vrodos_editor_director_helpers.js' ) )],
      ...
      ['vrodos_scene_transforms', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_transforms.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_scene_registry', 'vrodos_three_vendor_bundle'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/scene/vrodos_scene_transforms.js' ) )],
      ...
      ['vrodos_editor_render_loop', VRodos_Path_Manager::editor_js_url( 'render/vrodos_editor_render_loop.js' ), ['vrodos_namespace', 'vrodos_editor_services'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/render/vrodos_editor_render_loop.js' ) )],
      ...
      ['vrodos_rayCasters', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_raycasting.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_editor_services', 'vrodos_auxControlers']],
      ['vrodos_property_panel', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_property_panel.js' ), ['vrodos_namespace'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ui/vrodos_property_panel.js' ) )],
      ['vrodos_property_categories', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_property_categories.js' ), ['vrodos_namespace'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ui/vrodos_property_categories.js' ) )],
      ...
      ['vrodos_loader_pawn_assets', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_pawn_assets.js' ), ['vrodos_namespace', 'vrodos_loader_scene_asset_helpers', 'vrodos_loader_decoder_config']],
      ...
      ['vrodos_loader_director_camera', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_director_camera.js' ), ['vrodos_namespace', 'vrodos_loader_object_factories', 'vrodos_editor_services', 'vrodos_three_vendor_bundle'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/loaders/vrodos_loader_director_camera.js' ) )],
      ['vrodos_loader_generated_assets', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_generated_assets.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_loader_object_factories', 'vrodos_editor_services', 'vrodos_three_vendor_bundle', 'vrodos_surface_material', 'vrodos_loader_decoder_config', 'vrodos_loader_glb_asset_cache']],
      ['vrodos_loader_glb_assets', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_glb_assets.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_loader_object_factories', 'vrodos_editor_services', 'vrodos_loader_decoder_config', 'vrodos_loader_glb_asset_cache', 'vrodos_model_origin'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/loaders/vrodos_loader_glb_assets.js' ) )],
      ['vrodos_LoaderMulti', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_multi.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_loader_object_factories', 'vrodos_loader_resource_metadata', 'vrodos_loader_director_camera', 'vrodos_loader_generated_assets', 'vrodos_loader_glb_assets', 'vrodos_loader_decoder_config', 'vrodos_scene_settings_sync', 'vrodos_editor_services'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/loaders/vrodos_loader_multi.js' ) )],
      ...
      ['vrodos_scene_disposal', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_disposal.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_loader_glb_asset_cache']],
      ['vrodos_addRemoveOne', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_object_actions.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_editor_core_utils', 'vrodos_ScenePersistence', 'vrodos_editor_services', 'vrodos_scene_disposal', 'vrodos_loader_object_factories', 'vrodos_loader_generated_assets', 'vrodos_loader_light_assets', 'vrodos_loader_pawn_assets', 'vrodos_loader_scene_lifecycle', 'vrodos_HierarchyViewer']],
      ['vrodos_ui_helpers', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_ui_helpers.js' ), ['vrodos_namespace', 'wp-date'], $ui_helpers_version],
      ...
      ['vrodos_editor_shell_ui', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_editor_shell_ui.js' ), ['vrodos_namespace', 'vrodos_ui_helpers', 'vrodos_editor_services', 'vrodos_auxControlers', 'vrodos_scripts', 'ajax-script_uploadimage']],
      ['vrodos_editor_toolbar_ui', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_editor_toolbar_ui.js' ), ['vrodos_namespace', 'vrodos_ui_helpers', 'vrodos_editor_services', 'vrodos_3d_editor_environmentals', 'vrodos_BordersFinder', 'vrodos_movePointerLocker', 'vrodos_scripts', 'ajax-script_savescene', 'vrodos_addRemoveOne']],
      ['vrodos_compile_dialog_ui', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_compile_dialog_ui.js' ), ['vrodos_namespace', 'vrodos_ui_helpers', 'vrodos_compile_dialogue', 'vrodos_CompileUI_Profiles', 'ajax-script_compile', 'ajax-script_savescene'], $compile_dialog_ui_version],
      ...
      ['vrodos_HierarchyViewer', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_hierarchy_viewer.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_ui_helpers', 'vrodos_ScenePersistence', 'vrodos_cefr_badges'], (string) filemtime( VRodos_Path_Manager::asset_path( 'js/editor/ui/vrodos_hierarchy_viewer.js' ) )],
      ...
      ['vrodos_CompileUI_PostFX', VRodos_Path_Manager::editor_js_url( 'ui/compile/vrodos_compile_ui_postfx.js' ), ['vrodos_namespace', 'vrodos_CompileUI_Shared'], $compile_postfx_version],
	...
	public function register_styles() {
		$runtime_config           = VRodos_Render_Runtime_Manager::get_config();
		$browser_library_versions = (array) $runtime_config['browser_library_versions'];
		$asset_browser_css_path    = VRodos_Path_Manager::asset_path( 'css/editor/vrodos_3D_editor_browser.css' );
		$asset_browser_css_version = (string) filemtime( $asset_browser_css_path );
	...
	private function enqueue_three_vendor_bundle(): void {
		...
		$three_draco_decoder_url = (string) $runtime_config['three_draco_decoder_url'];
		$three_basis_transcoder_url = (string) $runtime_config['three_basis_transcoder_url'];
		$three_meshopt_decoder_url = (string) $runtime_config['three_meshopt_decoder_url'];
		$takram_cloud_assets = [
		...
		$inline_script = 'window.vrodos_three_vendor_dir = ' . wp_json_encode( $three_vendor_dir ) . ';'
			...
			. 'window.vrodos_three_draco_decoder_path = ' . wp_json_encode( $three_draco_decoder_url ) . ';'
