...
class VRodos_Asset_Manager {
	...
	public function register_scripts() {
      ...
      ['vrodos_3d_editor_buttons_drags', VRodos_Path_Manager::editor_js_url( 'vrodos_3d_editor_buttons_drags.js' ), ['vrodos_namespace', 'vrodos_scene_editor_ui_controller']],
      ...
      ['vrodos_3d_editor_environmentals', VRodos_Path_Manager::editor_js_url( 'vrodos_3d_editor_environmentals.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_editor_environment_helpers', 'vrodos_editor_performance_profile', 'vrodos_editor_renderer_lifecycle', 'vrodos_editor_cameras', 'vrodos_editor_director_helpers']],
      ...
      ['vrodos_loader_scene_asset_helpers', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_scene_asset_helpers.js' ), ['vrodos_namespace', 'vrodos_loader_object_factories', 'vrodos_editor_services']],
      ...
      ['vrodos_loader_resource_metadata', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_resource_metadata.js' ), ['vrodos_namespace', 'vrodos_scene_settings_sync', 'vrodos_editor_services']],
      ...
      ['vrodos_LightsPawn_Loader', VRodos_Path_Manager::editor_js_url( 'loaders/vrodos_loader_lights_pawn.js' ), ['vrodos_namespace', 'vrodos_loader_resource_metadata', 'vrodos_loader_light_assets', 'vrodos_loader_pawn_assets', 'vrodos_editor_services', 'vrodos_three_vendor_bundle']],
      ...
      ['vrodos_addRemoveOne', VRodos_Path_Manager::editor_js_url( 'vrodos_addRemoveOne.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_editor_core_utils', 'vrodos_editor_services', 'vrodos_scene_disposal']],
      ...
      ['vrodos_CompileUI_Shared', VRodos_Path_Manager::editor_js_url( 'vrodos_CompileUI_Shared.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_runtime_settings_contract']],
      ...
      ['vrodos_EditorInitializer', VRodos_Path_Manager::editor_js_url( 'vrodos_EditorInitializer.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_editor_diagnostics', 'vrodos_editor_services', 'vrodos_editor_render_loop', 'vrodos_scripts', 'vrodos_scene_settings_sync', 'ajax-script_savescene', 'vrodos_loader_scene_lifecycle', 'vrodos_3d_editor_environmentals', 'vrodos_addRemoveOne', 'vrodos_3d_editor_buttons_drags', 'vrodos_scene_editor_ui_controller']],
