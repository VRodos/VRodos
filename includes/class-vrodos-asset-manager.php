...
class VRodos_Asset_Manager {
	...
	public function register_scripts() {
      ...
      ['vrodos_auxControlers', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_property_controls.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_editor_services']],
      ...
      ['vrodos_addRemoveOne', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_object_actions.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_editor_core_utils', 'vrodos_editor_services', 'vrodos_scene_disposal']],
      ...
      ['vrodos_cefr_badges', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_cefr_badges.js' ), ['vrodos_namespace']],
      ['vrodos_HierarchyViewer', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_hierarchy_viewer.js' ), ['vrodos_namespace', 'vrodos_cefr_badges']],
      ...
      ['vrodos_EditorInitializer', VRodos_Path_Manager::editor_js_url( 'core/vrodos_editor_initializer.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_editor_diagnostics', 'vrodos_editor_services', 'vrodos_editor_render_loop', 'vrodos_scripts', 'vrodos_scene_settings_sync', 'ajax-script_savescene', 'vrodos_loader_scene_lifecycle', 'vrodos_3d_editor_environmentals', 'vrodos_addRemoveOne', 'vrodos_3d_editor_buttons_drags', 'vrodos_scene_editor_ui_controller']],
