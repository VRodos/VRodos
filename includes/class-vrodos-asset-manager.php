...
class VRodos_Asset_Manager {
	...
	public function register_scripts() {
      ...
      ['vrodos_addRemoveOne', VRodos_Path_Manager::editor_js_url( 'scene/vrodos_scene_object_actions.js' ), ['vrodos_namespace', 'vrodos_scene_light_artifacts', 'vrodos_editor_core_utils', 'vrodos_ScenePersistence', 'vrodos_editor_services', 'vrodos_scene_disposal']],
      ...
      ['vrodos_HierarchyViewer', VRodos_Path_Manager::editor_js_url( 'ui/vrodos_hierarchy_viewer.js' ), ['vrodos_namespace', 'vrodos_editor_core_utils', 'vrodos_cefr_badges']],
