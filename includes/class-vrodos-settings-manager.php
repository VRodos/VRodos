...
class VRodos_Settings_Manager {
	...
	public function load_settings(): void {
		...
		$this->general_settings = array_merge(
			['vrodos_unity_local_or_remote'          => 'remote', 'vrodos_unity_exe_folder'               => 'C:\Program Files\Unity', 'vrodos_remote_api_folder'              => 'http://myurl/', 'vrodos_ftp_address'                    => '', 'vrodos_ftp_username'                   => '', 'vrodos_ftp_pass'                       => '', 'vrodos_server_path'                    => 'C:/xampp/htdocs/COMPILE_UNITY3D_GAMES/', 'vrodos_google_application_credentials' => ''],
	...
	public function register_general_settings(): void {
		...
		add_settings_field(
			'vrodos_unity_local_or_remote',
			__( 'Compile in this server or remote server?' ),
			$this->field_vrodos_unity_local_or_remote(...),
	...
	public function section_general_desc() {
		echo __( 'Settings concerning the functionality of the application' ); }
