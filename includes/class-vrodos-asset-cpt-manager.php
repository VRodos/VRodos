...
class VRodos_Asset_CPT_Manager {
	...
	private function define_asset_fields(): void {
      ...
      ['3D Text Content', '3D Text Content', 'vrodos_asset3d_text_content', 'string', '', true, true],
      ['3D Text File', '3D Text Source File', 'vrodos_asset3d_text_file', 'string', '', true, true],
