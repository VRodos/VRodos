...
class vrodos_settingsPage {
    ...
    function field_vrodos_unity_local_or_remote(){
        ?>
    ...
    function field_vrodos_unity_exe_folder(){
        ?>
    ...
    function field_vrodos_remote_api_folder(){
        ?>
    ...
    function field_vrodos_ftp_address(){
        ?>
    ...
    function field_vrodos_ftp_username(){
        ?>
    ...
    function field_vrodos_ftp_pass(){
        ?>
    ...
    function field_vrodos_server_path(){
        ?>
    ...
    function field_vrodos_google_application_credentials(){
        ?>
     ...
     * page under Settings called vrodos Settings, rendered
