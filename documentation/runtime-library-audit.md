...
| postprocessing | 6.39.5; root lock | Three `>=0.168 <0.186` | composer/effects public exports | `build-runtime-vendors.mjs`; lazy PMNDRS | `vrodos-postprocessing.bundle.js` | [postprocessing docs](https://pmndrs.github.io/postprocessing/public/docs/) |
| three-mesh-bvh | 0.9.15; root lock | Three `>=0.159` | `acceleratedRaycast`, `computeBoundsTree`, `disposeBoundsTree` | `build-runtime-vendors.mjs`; lazy collision | `vrodos-collision-bvh.bundle.js` | [three-mesh-bvh](https://github.com/gkjohnson/three-mesh-bvh) |
