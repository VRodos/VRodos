...
|---|---|---|---|---|---|---|
| A-Frame | 1.8.0 master artifact at `e145c1a`; root `vrodos.runtime` | Bundles its compatible Three runtime | scene/components, `gltf-model`, WebXR renderer | `build-three-vendor.mjs`; baseline | `assets/vendor/aframe/aframe-master.min.js` | [A-Frame 1.8.0](https://aframe.io/docs/1.8.0/introduction/) |
| Three (`super-three` alias) | 0.185.0; root lock | n/a | core classes and documented addons/loaders | `build-three-vendor.mjs`; baseline | `assets/vendor/three-r185/` | [Three.js r185 docs](https://threejs.org/docs/) |
| postprocessing | 6.39.2; root lock | Three `>=0.168 <0.186` | composer/effects public exports | `build-three-vendor.mjs`; lazy PMNDRS | `vrodos-postprocessing.bundle.js` | [postprocessing docs](https://pmndrs.github.io/postprocessing/public/docs/) |
| three-mesh-bvh | 0.9.11; root lock | Three `>=0.159` | `acceleratedRaycast`, `computeBoundsTree`, `disposeBoundsTree` | `build-three-vendor.mjs`; lazy collision | `vrodos-collision-bvh.bundle.js` | [three-mesh-bvh](https://github.com/gkjohnson/three-mesh-bvh) |
| @takram/three-atmosphere | 0.19.1; root lock | Three `>=0.170`, postprocessing `>=6.36.7`; React peers optional for vanilla exports | package-root atmosphere/celestial exports | `build-three-vendor.mjs`; lazy atmosphere | `vrodos-takram-atmosphere.bundle.js` | [three-atmosphere](https://github.com/takram-design-engineering/three-geospatial/tree/main/packages/three-atmosphere) |
| @takram/three-clouds | 0.7.6; root lock | Three `>=0.170`, postprocessing `>=6.36.7`; React peers optional | package-root cloud exports | `build-three-vendor.mjs`; lazy clouds; gated UV patch | `vrodos-takram-clouds.bundle.js` | [three-clouds](https://github.com/takram-design-engineering/three-geospatial/tree/main/packages/three-clouds) |
...
| @takram/three-geospatial-effects | 0.6.4; root lock | Three `>=0.170`, postprocessing `>=6.36.4`; React peers optional | package-root effects | `build-three-vendor.mjs`; lazy atmosphere | folded into Takram bundle | [three-geospatial effects](https://github.com/takram-design-engineering/three-geospatial) |
| @pmndrs/uikit | 1.0.74; root lock | Three `>=0.162` | vanilla `Root`, containers/text/input lifecycle | `build-runtime-master-bundles.mjs`; lazy spatial UI | `vrodos-runtime-spatial-ui.bundle.js` | [UIKit vanilla guide](https://pmndrs.github.io/uikit/docs/getting-started/vanilla) |
| @pmndrs/uikit-horizon | 1.0.74; root lock | UIKit/Three through package graph | Horizon components | spatial UI bundle; lazy | spatial UI bundle | [UIKit Horizon](https://pmndrs.github.io/uikit/docs/) |
| @pmndrs/uikit-lucide | 1.0.74; root lock | UIKit/Three through package graph | icon components | spatial UI bundle; lazy | spatial UI bundle | [UIKit icons](https://pmndrs.github.io/uikit/docs/) |
...
| @pmndrs/msdfonts | 1.0.74; direct root lock | package graph | font/MSDF support imported by UIKit | spatial UI bundle; lazy | spatial UI/font assets | [UIKit text](https://pmndrs.github.io/uikit/docs/) |
...
|---|---|---|---|---|---|
| @gltf-transform/cli | 4.4.1; root lock | none declared | explicit GLB audit/derivative tooling | CLI only | [glTF Transform](https://gltf-transform.dev/) |
| esbuild | 0.28.1; root lock | none declared | all generated browser bundles | build only | [esbuild](https://esbuild.github.io/) |
