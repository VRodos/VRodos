...
| Generated client assembly, single-player/network targeting, template placeholders | `includes/class-vrodos-compiler-runtime-page-builder.php`, `includes/class-vrodos-compiler-target-renderer.php`, `templates/runtime/aframe/` | `npm run test:compiler`, PHP syntax for edited PHP |
...
| Single-player/networked runtime behavior | `includes/class-vrodos-compiler-manager.php`, `includes/class-vrodos-compiler-target-renderer.php`, `assets/js/runtime/master/networked/` | `npm run test:compiler`, networked manual smoke when release-relevant |
