...
Low inherits the previous Medium preset: Web Medium 2048px KTX2 textures, a 192 MiB scene target, 80% visual geometry, a 3.7 MP/DPR 1 budget, static Medium shadows, Medium SMAA, Balanced atmosphere, and no clouds by default. Medium uses Web High 4096px KTX2 textures, a 256 MiB target, exact geometry, a 5 MP/DPR 1.25 budget, High SMAA, Quality atmosphere, and Low-quality clouds without shafts. High is the high-fidelity preset: Web High 4096px textures without a scene texture-memory target, exact geometry, DPR up to 2, high dynamic shadows, Ultra SMAA and High clouds (Ultra selectable), Cinematic atmosphere, and enhanced reflections with 256px slowly updated scene probes when that reflection source is authored. Authored artistic settings and effect toggles remain shared; Custom keeps the exact authored settings. Collision/navigation assets plus skinned or morph-target GLBs are never simplified.
