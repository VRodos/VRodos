...
function vrodosCreateSAOMaterial() {
    ...
    // occlusion. No normal reconstruction needed â€” avoids halo artifacts on edges.
    var material = new THREE.ShaderMaterial({
        ...
        fragmentShader: [
            ...
            '  // World-space AO radius â€” how far (in units) to look for occluders',
            '  float aoRadius = kernelRadius;',
            '  // Convert world-space radius to screen pixels at this depth',
            '  // Approximate: screenPixels â‰ˆ worldSize * (size.y / (2 * depth * tan(fov/2)))',
