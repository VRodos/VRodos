...
- `VRodos_Compiler_Asset_Policy`: shared VR GLB derivative and texture-cap selection. Standalone headset builds use project-wide `vrHeadsetAssetQuality` (Low/default 1024px, Medium 2048px, High 4096px/preserved geometry), independently of renderer policy.
