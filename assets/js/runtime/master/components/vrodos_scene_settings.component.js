...
AFRAME.registerComponent('scene-settings', {
    ...
    isHeadsetPmndrsStereoComposerForceEnabled: function () {
        return vrodosRuntimeDebugFlag('forceXrPmndrsStereoComposer', 'vrodos_force_xr_pmndrs_stereo_composer') ||
    ...
    vrRuntimeAllows: function (capability, authored) {
        if (
            ...
            (this.isHeadsetPmndrsStereoComposerForceEnabled() || this.canUseVrHeadsetStereoPmndrsComposer())
        ) {
        ...
        return {
            ...
            takram: {
                ...
                moon: {
                    ...
                    angularRadiusInvariant: Boolean(moonDiagnostics.angularRadiusInvariant),
                    projectedDiscEnabled: Boolean(moonDiagnostics.projectedDiscEnabled),
                    ...
                    siderealDriftEnabled: Boolean(moonDiagnostics.siderealDriftEnabled),
                ...
                cloudLightShaftsResourcesPrepared: Boolean(cloudDiagnostics.cloudLightShaftsResourcesPrepared),
                cloudShadowLengthGenerationEnabled: Boolean(cloudDiagnostics.cloudShadowLengthGenerationEnabled),
                ...
                cloudAerialShadowLengthBufferReady: Boolean(cloudDiagnostics.aerialShadowLengthBufferReady),
                cloudAerialShadowLengthDefineReady: Boolean(cloudDiagnostics.aerialShadowLengthDefineReady),
                cloudAerialLightingMaskDefineReady: Boolean(cloudDiagnostics.aerialLightingMaskDefineReady),
                ...
                cloudsLensFlareCloudFactor: typeof cloudDiagnostics.lensFlareCloudFactor === 'number'
                    ...
                    : null,
                cloudSunOcclusionEnabled: Boolean(cloudDiagnostics.cloudSunOcclusionEnabled),
                cloudSunOcclusionStrength: typeof cloudDiagnostics.cloudSunOcclusionStrength === 'number'
                    ? cloudDiagnostics.cloudSunOcclusionStrength
                    : null,
                cloudSunDirectFactor: typeof cloudDiagnostics.cloudSunDirectFactor === 'number'
                    ? cloudDiagnostics.cloudSunDirectFactor
                    : null,
                cloudSkyFactor: typeof cloudDiagnostics.cloudSkyFactor === 'number'
                    ? cloudDiagnostics.cloudSkyFactor
                    : null,
                ...
                cloudSunCoverageStrength: typeof cloudDiagnostics.cloudSunCoverageStrength === 'number'
                    ? cloudDiagnostics.cloudSunCoverageStrength
                    : null,
