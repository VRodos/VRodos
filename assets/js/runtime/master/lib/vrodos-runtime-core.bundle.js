...
`;
  ...
  (function() {
    ...
    function isVrTakramSkyProfile(self) {
      return Boolean(self && typeof self.isVrRuntimePolicyActive === "function" && self.isVrRuntimePolicyActive() && typeof self.isVrRuntimeTakramSkyProfile === "function" && self.isVrRuntimeTakramSkyProfile() && self.data && self.data.selChoice === "0");
    }
