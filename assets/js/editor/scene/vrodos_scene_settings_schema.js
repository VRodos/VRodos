...
VRODOS.config.SCENE_SETTINGS_SCHEMA = {
    ...
    'aframePmndrsLowLightAutoExposureEnabled': { type: 'boolean', default: vrodosEditorSceneSettingDefault('pmndrsLowLightAutoExposureEnabled', true), envirKey: 'aframePmndrsLowLightAutoExposureEnabled' },
    'aframePmndrsToneMappingExposureAuthored': { type: 'boolean', default: vrodosEditorSceneSettingDefault('pmndrsToneMappingExposureAuthored', false), envirKey: 'aframePmndrsToneMappingExposureAuthored' },
    ...
    'aframePmndrsCloudsEnabled': { type: 'boolean', default: vrodosEditorSceneSettingDefault('pmndrsCloudsEnabled', false), envirKey: 'aframePmndrsCloudsEnabled' },
    'aframePmndrsCloudsQuality': { type: 'string', default: vrodosEditorSceneSettingDefault('pmndrsCloudsQuality', 'low'), envirKey: 'aframePmndrsCloudsQuality' },
    'aframePmndrsCloudsCoverage': { type: 'number', default: vrodosEditorSceneSettingDefault('pmndrsCloudsCoverage', 0.35), envirKey: 'aframePmndrsCloudsCoverage' },
    'aframePmndrsCloudsStyle': { type: 'string', default: vrodosEditorSceneSettingDefault('pmndrsCloudsStyle', 'default'), envirKey: 'aframePmndrsCloudsStyle' },
    'aframePmndrsCloudsWindEnabled': { type: 'boolean', default: vrodosEditorSceneSettingDefault('pmndrsCloudsWindEnabled', true), envirKey: 'aframePmndrsCloudsWindEnabled' },
    'aframePmndrsCloudsWindSpeed': { type: 'number', default: vrodosEditorSceneSettingDefault('pmndrsCloudsWindSpeed', 1.0), envirKey: 'aframePmndrsCloudsWindSpeed' },
    'aframePmndrsCloudsWindDirectionDeg': { type: 'number', default: vrodosEditorSceneSettingDefault('pmndrsCloudsWindDirectionDeg', 0), envirKey: 'aframePmndrsCloudsWindDirectionDeg' },
    ...
    'aframePmndrsDayNightCycleEnabled': { type: 'boolean', default: vrodosEditorSceneSettingDefault('pmndrsDayNightCycleEnabled', false), envirKey: 'aframePmndrsDayNightCycleEnabled' },
    'aframePmndrsDayNightCycleDurationMinutes': { type: 'number', default: vrodosEditorSceneSettingDefault('pmndrsDayNightCycleDurationMinutes', 1.0), envirKey: 'aframePmndrsDayNightCycleDurationMinutes' },
    ...
    'aframePmndrsStarsEnabled': { type: 'string', default: vrodosEditorSceneSettingDefault('pmndrsStarsEnabled', 'auto'), envirKey: 'aframePmndrsStarsEnabled' },
