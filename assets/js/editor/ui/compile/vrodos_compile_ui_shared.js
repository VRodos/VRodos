...
VRodosCompileUI.Shared = (function () {
    ...
    const PMNDRS_TWEAK_DEFAULTS = {
        ...
        cloudsWindEnabled: contractDefault('pmndrsCloudsWindEnabled', true),
        cloudsWindSpeed: contractDefault('pmndrsCloudsWindSpeed', 1.0),
        cloudsWindDirectionDeg: contractDefault('pmndrsCloudsWindDirectionDeg', 0),
