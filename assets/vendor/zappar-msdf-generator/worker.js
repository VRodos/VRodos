/* Bundled by scripts/build-runtime-master-bundles.mjs for VRodos spatial UI font atlas generation. */
...
var createMSDFGenModule = (() => {
  ...
  return (function(moduleArg = {}) {
    ...
    function pa(a) {
      var _a;
      (_a = m.onAbort) == null ? void 0 : _a.call(m, a);
      a = "Aborted(" + a + ")";
      w(a);
      B = true;
...
`, t.push(`${f}_dtor`));
    ...
    var qb = (a) => {
      ...
      var _a;
      fa = a;
      ya || 0 < Fb || ((_a = m.onExit) == null ? void 0 : _a.call(m, a), B = true);
      throw new va(a);
    }, Ib = (a) => {
      if (!B) try {
        if (a(), !(ya || 0 < Fb)) try {
    ...
    Object.assign(cb.prototype, { la(a) {
      ...
      var _a;
      (_a = this.R) == null ? void 0 : _a.call(this, a);
    ...
    (async function() {
      ...
      function a(d) {
        ...
        ma.unshift(Z.B);
        I--;
        (_a2 = m.monitorRunDependencies) == null ? void 0 : _a2.call(m, I);
        0 == I && J && (d = J, J = null, d());
        return Z;
      }
      I++;
      (_a = m.monitorRunDependencies) == null ? void 0 : _a.call(m, I);
      var b = { a: Ob };
      ...
      ra != null ? ra : ra = m.locateFile ? qa("msdfgen_wasm.wasm") ? "msdfgen_wasm.wasm" : m.locateFile ? m.locateFile("msdfgen_wasm.wasm", r) : r + "msdfgen_wasm.wasm" : new URL("msdfgen_wasm.wasm", import_meta.url).href;
      try {
        var c = await ua(b);
        a(c.instance);
        return c;
    ...
    function Rb() {
      function a() {
        ...
        if (!Pb && (Pb = true, m.calledRun = true, !B)) {
          wa(ma);
          aa(m);
          (_a = m.onRuntimeInitialized) == null ? void 0 : _a.call(m);
    ...
    for (let i = 0; i < chars.length; i++) {
      ...
      for (let py = 0; py < glyphHeight; py++) {
        for (let px = 0; px < glyphWidth; px++) {
          ...
          texture[dstIdx + 0] = (_a = result.data.get(srcIdx + 0)) != null ? _a : 0;
          texture[dstIdx + 1] = (_b = result.data.get(srcIdx + 1)) != null ? _b : 0;
          texture[dstIdx + 2] = (_c = result.data.get(srcIdx + 2)) != null ? _c : 0;
...
var MSDFGeneratorWorker = class {
  constructor() {
    __publicField(this, "generator", null);
  }
  ...
  dispose() {
    var _a;
    (_a = this.generator) == null ? void 0 : _a.dispose();
    this.generator = null;
  }
