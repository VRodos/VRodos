...
| Scene-owned lighting/material parity | Pending | `Master_Client_8606.html?vrodos_vr_profile=safe&vrodos_debug_runtime_features=1` | `vrProfile.profile=safe`, no composer, no Takram visible sky, no clouds, no scene probe, no reflections, stable shadows/materials | Not yet validated on headset | Compare readability, static shadows, tone mapping/exposure, material profiles, and flat media readability on the current built page |
