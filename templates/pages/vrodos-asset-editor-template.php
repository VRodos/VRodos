        ...
        <div class="tw-w-full tw-flex tw-items-center tw-justify-between">
            ...
            <div class="tw-flex tw-items-center tw-gap-6">
                ...
                <div class="tw-flex tw-items-center tw-gap-2 tw-bg-slate-50 tw-px-3 tw-py-1.5 tw-rounded-lg tw-border tw-border-slate-100">
                    <i data-lucide="<?php echo $isShared ? 'globe' : 'folder'; ?>" class="tw-w-3 tw-h-3 tw-text-slate-400"></i>
                    <span class="tw-text-[10px] tw-font-black tw-uppercase tw-tracking-wider <?php echo $isShared ? 'tw-text-slate-500' : 'tw-text-primary'; ?>">
                        <?php if ($isShared): ?>
                            Shared Assets
