...
const VRODOS_SCENE_SETTINGS_SCHEMA = {
    ...
    'aframePmndrsSunElevationDeg': { type: 'number', default: 10, envirKey: 'aframePmndrsSunElevationDeg' },
    'aframePmndrsSunAzimuthDeg': { type: 'number', default: 38, envirKey: 'aframePmndrsSunAzimuthDeg' },
    'aframePmndrsSunDistance': { type: 'number', default: 5200, envirKey: 'aframePmndrsSunDistance' },
    'aframePmndrsSunAngularRadius': { type: 'number', default: 0.0068, envirKey: 'aframePmndrsSunAngularRadius' },
    'aframePmndrsAerialStrength': { type: 'number', default: 0.85, envirKey: 'aframePmndrsAerialStrength' },
    'aframePmndrsAlbedoScale': { type: 'number', default: 0.96, envirKey: 'aframePmndrsAlbedoScale' },
    ...
    'aframePmndrsGroundAlbedo': { type: 'color', default: '#f0e6d6', envirKey: 'aframePmndrsGroundAlbedo' },
    'aframePmndrsRayleighScale': { type: 'number', default: 1.0, envirKey: 'aframePmndrsRayleighScale' },
    'aframePmndrsMieScatteringScale': { type: 'number', default: 0.9, envirKey: 'aframePmndrsMieScatteringScale' },
    'aframePmndrsMieExtinctionScale': { type: 'number', default: 1.0, envirKey: 'aframePmndrsMieExtinctionScale' },
    'aframePmndrsMiePhaseG': { type: 'number', default: 0.8, envirKey: 'aframePmndrsMiePhaseG' },
    'aframePmndrsAbsorptionScale': { type: 'number', default: 1.0, envirKey: 'aframePmndrsAbsorptionScale' },
