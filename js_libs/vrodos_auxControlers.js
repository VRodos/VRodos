...
//controlInterface.domElement.id = 'translatePanelGui';
...
for (let key in gui_controls_funs){
    dg_controller[i++] = controlInterface.add(gui_controls_funs, key).step(0.001).name(actionLabel[i-1] + " " + coordLabel[(i-1)%3]);
}
