...
THREE.SceneExporter.prototype = {
    ...
    parse: function (scene) {
        ...
        var output = [
            ...
            '       "fogcolor" : "' + (envir.scene.fogcolor ? envir.scene.fogcolor : '#000000') + '",',
            '       "fogfar" : "' + (envir.scene.fogfar ? envir.scene.fogfar : '1000000') + '",' ,
            '       "fognear" : "' + (envir.scene.fognear ? envir.scene.fognear : '1000000') + '",', 
